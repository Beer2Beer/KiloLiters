...
/**
 * Created by federico on 23/03/14.
 */
...
public class FragmentRicercaStazioniProva extends Fragment implements LocationListener {

    //instance variables for Marker icon drawable resources
    private int userIcon, foodIcon, drinkIcon, shopIcon, otherIcon;

    //the map
    private MapFragment theMap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.view_ricerca_stazioni, container, false);

        if (theMap == null) {
            //get the map
            theMap = ((MapFragment) this.getActivity()
        ...
        theMap.getMap().getUiSettings().setMyLocationButtonEnabled(true);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        otherIcon = R.drawable.gas_station;
    ...
    public void onLocationChanged(Location location) {
        ...
        theMap.getMap().animateCamera(CameraUpdateFactory.newLatLng(lastLatLng), 3000, null);
        */
...
/*        userMarker = theMap.getMap().addMarker(new MarkerOptions()
                .position(lastLatLng)
                .title("You are here")
  ...
  */
        ...
        String placesSearchStr = "https://maps.googleapis.com/maps/api/place/nearbysearch/" +
                "json?location=44.7832193,10.3246615" +
                "&radius=10000&sensor=true" +
                "&types=gas_station"+
                "&key=AIzaSyDQOzSn_VhdDuz26Hes3wtci9HHW6WZnyQ";//ADD KEY
        ...
        protected void onPostExecute(String result) {
            ...
            if(places!=null && placeMarkers!=null){
                for(int p=0; p<places.length && p<placeMarkers.length; p++){
                    ...
                    if(places[p]!=null)
                        placeMarkers[p]=theMap.getMap().addMarker(places[p]);
                }
            }
